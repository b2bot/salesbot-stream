...
import {
    ...
    Scissors,
    MapPin,
    Users // 1. Ícone 'Users' adicionado aqui
} from 'lucide-react';
...
const ModuloAgendaIndex: React.FC = () => {
    // 2. A classe de estilo foi definida como uma constante aqui
    const tabTriggerClass = "h-12 px-4 py-2 text-sm font-medium text-muted-foreground hover:text-foreground data-[state=active]:text-foreground data-[state=active]:border-b-2 data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:shadow-none rounded-none bg-transparent";
                ...
                <Tabs defaultValue="agenda" className="w-full">
                    <div className="px-6">
                        <TabsList className="h-12 w-full justify-start bg-transparent p-0 border-b-0">
                            <TabsTrigger
                                value="agenda"
                                className={tabTriggerClass} // Aplicada aqui
                            >
                    ...
                    <div className="flex-1">
                        ...
                        {/* Conteúdo da Nova Aba de Clientes */}
                        <TabsContent value="clientes" className="mt-0 border-0 p-0">
                            <ClientesPage />
                        </TabsContent>
