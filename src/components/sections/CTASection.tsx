  ...
  return (
    <section className="py-20 text-center bg-gradient-to-b from-brand/5 to-transparent">
      <div className="container mx-auto max-w-3xl">
        ...
        <p className="mt-3 text-muted-foreground">Comece hoje a transformar seu atendimento. Agende uma demonstração de 15 minutos e veja na prática como o B2Bot pode aumentar suas vendas.</p>
