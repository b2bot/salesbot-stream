...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === 'POST') {
      ...
      // Mock de check-in - em produção, atualizaria o banco de dados
      const mockResult = {
        appointmentId,
        status: 'in_progress',
      ...
      console.log(`Check-in realizado para agendamento ${appointmentId} pelo cliente ${clientId}`);
    ...
    console.error('Erro em /api/client-portal/modulo-agenda/check-in:', error);
